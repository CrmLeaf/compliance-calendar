/*
 * Progressive enhancement for Compliance Calendar.
 *
...
(function () {
    ...
    var TOOL = 'compliance-calendar';
    var CALCULATOR = 'complianceCalendar';
    var FIELDS = [
        { name: 'financial_year', argument: 'financialYear', type: 'string' },
        { name: 'only', argument: 'only', type: 'array' },
        { name: 'qrmp', argument: 'qrmp', type: 'bool' },
